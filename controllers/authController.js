...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        // Insert the new user into the database with role 0
        await db.query('INSERT INTO users (username, password, email, role, active, created_at, updated_at) VALUES (?, ?, ?, ?, ?, NOW(), NOW())', [username, hashedPassword, email, 0, true]);
